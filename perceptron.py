...
alpha = 1
T = 10
test_snippets_base = 'test/shortSnippets/'
predictions_base = 'test/shortpredictions/'
training_snippets_base = 'training/shortSnippets/'
...
for training_restaurant_name in training_restaurants:
	try:
		...
		for line in snips:
			vocab = vocab.union(set(re.sub(exclusion_regex, '', line.lower()).split(' ')))
		snips.close()
	except:
		pass
